    ...
    return (
      <div className="h-full flex flex-col">
        <div className="flex items-center gap-1">
          ...
          {isSales && <span className="shrink-0 inline-flex items-center justify-center h-4.5 w-4.5 rounded-full bg-emerald-500/30 ring-1 ring-emerald-400/50"><DollarSign className="h-3 w-3 text-emerald-300" strokeWidth={3} /></span>}
