    ...
    return (
      <div className="h-full flex flex-col">
        <div className="flex items-center gap-1">
          ...
          {isSales && <span className="shrink-0 inline-flex items-center justify-center h-4 w-4 rounded-full bg-emerald-500/30 ring-1 ring-emerald-400/50"><DollarSign className="h-2.5 w-2.5 text-emerald-300" /></span>}
