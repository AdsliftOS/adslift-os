    ...
    return (
      <div className="h-full flex flex-col">
        <div className="flex items-center gap-1">
          ...
          {isSales && <span className="shrink-0 inline-flex items-center justify-center h-4 w-4 rounded-full bg-white"><DollarSign className="h-3 w-3 text-emerald-600" /></span>}
